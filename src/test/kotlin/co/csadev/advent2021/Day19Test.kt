...
class Day19Test {
    ...
    fun `Matches example`() {
        ...
        Assertions.assertThat(part1).isEqualTo(79)

        val part2 = example.solvePart2()
        Assertions.assertThat(part2).isEqualTo(3621)
    }

    @Test
    fun `Actual answer`() {
        val part1 = real.solvePart1()
        Assertions.assertThat(part1).isEqualTo(342)

        val part2 = real.solvePart2()
        Assertions.assertThat(part2).isEqualTo(9668)
    }
}
